...
if (token) {
       ...
       ${arr
           .map((elem, index) => {
            ...
            <tr>
                ...
                <td>${
                    elem.bookingSlot == "8-9"
                        ? "8 AM to 9 AM"
                        : elem.bookingSlot == "9-10"
                        ? "9 AM to 10 AM"
                        : elem.bookingSlot == "4-5"
                        ? "4 PM to 5 PM"
                        : "7 PM to 8 PM"
                }</td>
                <td><button class="cancelAppointment" data-id=${
                    elem._id
                } >Cancel Appointments</button></td>
                <td><button class="videoCall" data-id=${
                    elem._id
                } >Video Call</button></td>
            </tr>
        `;
           })
           .join("")}
   ...
   `;
        ...
        let cancelAppointmentBtns =
            document.querySelectorAll(".cancelAppointment");
